...
public final class StreamingEncoder {
    ...
    private volatile boolean streaming; // streaming status used for pausing highFps mode
    ...
    public EncodedFrame dequeue() {
        ...
        if (buffer != null && streaming && bufferInfo.size > 0) {
